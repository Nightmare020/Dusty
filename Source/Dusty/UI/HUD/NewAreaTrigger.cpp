...
#include "NewAreaTrigger.h"
#include "Dusty/Character/DustyCharacter.h"
#include "Dusty/Utils/DustyConst.h"
#include "Dusty/Utils/DustyUtils.h"
#include "Components/BoxComponent.h"

void ANewAreaTrigger::NotifyActorBeginOverlap(AActor* OtherActor)
{
	if (OtherActor->IsA(ADustyCharacter::StaticClass()))
	{
		//DustyUtils::ShowHud(GetWorld(), EHudCanvas::NewArea, m_AreaId);
		Destroy();
	}
}

// Sets default values
ANewAreaTrigger::ANewAreaTrigger()
{
